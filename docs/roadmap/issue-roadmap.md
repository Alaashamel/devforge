...
| Engineering assistant (project-aware Q&A) | ai | ✅ done — streamed SSE replies grounded in one repository's chunks (migration 0012), persisted conversations + Assistant tab UI, PR #27 |
